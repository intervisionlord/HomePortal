<?php
# icons.php
# Файл констант иконок
# v.:0.1.5
# ©2020 intervision

define('ICO_QUESTION', '
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-question-square-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
